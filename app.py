...
with col1:
    ...
    diet_score = st.number_input("Diet Score (0-10)", min_value=0, max_value=10, value=1)
    sleep_hours = st.number_input("Sleep Hours Per Day", min_value=3, max_value=12, value=4)
    screen_time = st.number_input("Screen Time (hours/day)", min_value=0, max_value=12, value=10)
